...
$ goaudit scan-project . --node-image node:current-slim --upgrade-mode ncu`}
          ...
          <p className="mb-4 text-gray-600 dark:text-gray-400">
            ...
            The expanded tracing engine actively monitors for environment variable theft (<code className="bg-gray-100 dark:bg-gray-800 rounded px-1 text-sm">/proc/self/environ</code>), process injection (<code className="bg-gray-100 dark:bg-gray-800 rounded px-1 text-sm">ptrace</code>), fileless execution (<code className="bg-gray-100 dark:bg-gray-800 rounded px-1 text-sm">memfd_create</code>), privilege escalation (<code className="bg-gray-100 dark:bg-gray-800 rounded px-1 text-sm">setuid</code>/<code className="bg-gray-100 dark:bg-gray-800 rounded px-1 text-sm">setgid</code>), and unauthorized network port binding.
          </p>
